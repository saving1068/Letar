<template>
	...
	<div class="bigL cf" style="float: left;width: 927px;">
		<div class="seekPageLeft">
			<h2>
				<span @click="goToMore">全部课程<i class="fa fa-angle-right"></i></span>
				<span v-if="this.$route.query.search">{{this.$route.query.search}}<i class="fa fa-angle-right"></i></span>
				<span @click="goTofirstClass" v-if="this.$route.query.firstName">{{this.$route.query.firstName}}<i class="fa fa-angle-right"></i></span>
				<span @click="goTosecondClass" v-if="this.$route.query.secondName">{{this.$route.query.secondName}}<i class="fa fa-angle-right"></i></span>
				<span v-if="this.$route.query.thirdName">{{this.$route.query.thirdName}}<i class="fa fa-angle-right"></i></span>
			</h2>
		...
		<div class="seekCen">	
			...
			<div class="curriculumTabNav">
				<ul class="curriculumTabNavA cf" id="navA">
					<li v-for="(item,index) in navA" v-text="item.name" @click="navA_click(index,item.a)"></li>
				</ul>
...
export default {
    ...
    return {
  		...
  		priceSort:true,
  		classPage:1,
  		firstClass:this.$route.query.firstClass,
  		secondClass:this.$route.query.secondClass,
  		thirdClass:this.$route.query.thirdClass
    }
  },
	
  created(){
  	if(this.$route.query.search){
  		console.log(this.$route.query.search,"关键字")
  		var obj = {
  			a:0,
  			web:2,
  			sk:this.$route.query.search
  		}
  		console.log(obj)
  		this.getSeachList(obj)
  	}else{
  		console.log("课程ID")
	  	if(this.$route.query.level==1){
	  		console.log(this.$route.query.firstClass,"firstClass")
	  		var obj = {
	  			a:0,
	  			web:2,
	  			priceSort:1,
	  		...
	  		console.log(obj)
	  		this.getCouseList(obj)
	  	}else if(this.$route.query.level==2){
	  		console.log(this.$route.query.secondClass,"secondClass")
	  		var obj = {
	  			a:0,
	  			web:2,
	  			priceSort:1,
	  		...
	  		console.log(this.$route.query.thirdClass,"thirdClass")
	  		var obj = {
	  			a:0,
	  			web:2,
	  			priceSort:1,
  ...
  methods:{
  	...
  	goTosecondClass(){
  		...
  		this.$router.push({
  			...
  			query:{
  				...
  				name:this.$route.query.firstName,
  				secondClass:this.secondClass,
  				secondName:this.$route.query.secondName
  			}
  	...
  	current_change(val){
  		...
  		if(this.$route.query.firstClass){
  			obj.firstClass = this.$route.query.firstClass
  			obj.secondClass = this.oneClassId
  		}else if(this.$route.query.secondClass){
  			obj.secondClass = this.$route.query.secondClass
  		}else if(this.$route.query.thirdClass){
  			obj.thirdClass = this.$route.query.thirdClass
  		}
		this.getCouseList(obj)
  	},
  	next(){
  	...
  	getCouseList(obj){//tab的内容
  		this.$Api.getCourseList(obj).then((res)=>{
  			if(this.ifNav){
  				if(this.$route.query.search){
  					this.nav = [];
  				}else if(this.$route.query.thirdClass){
  					this.nav = [{name:this.$route.query.thirdName,id:this.$route.query.thirdClass}];
  				}else{
...
.curriculumNavB-Style{color: #3babf5 !important;background: #fff !important;}*/
...
<style type="text/css">
	...
	.pagination>.el-pagination .btn-next .el-icon,.el-pagination .btn-prev .el-icon{font-size: 15px !important;}
</style>