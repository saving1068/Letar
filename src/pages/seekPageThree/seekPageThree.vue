	...
	<section class="seekPage cf">
		...
		<div class="seekPageLeft">
			<h2 >
				...
				<span v-if="this.$route.query.firstName" @click="goTobackTwo">{{this.$route.query.firstName}}<i class="fa fa-angle-right"></i></span>
				<span v-if="this.$route.query.secondName">{{this.$route.query.secondName}}<i class="fa fa-angle-right"></i></span>
				<span v-if="this.$route.query.thirdName">{{this.$route.query.thirdName}}</span>
			</h2>
			...
			<div class="curriculumNav cf">
				...
				<ul class="curriculumNavRight">
					<li v-for="(item,index) in nav" @click="nav_click(index,item.id)">{{item.name}}</li>
					<!--<li>创业</li>
					<li>职场</li>
					<li>生活</li>
					<li>商会</li>
